...
public class HLLSample {
    ...
    public void execute() throws Exception {
        ...
        System.out.println("HLLSample.execute()");
        ...
        // this section deserializes the sketches, produces union and prints the results
        {
            ...
            in1.read(bytes1);
            in1.close();
            HllSketch sketch1 = HllSketch.heapify(WritableMemory.writableWrap(bytes1));
            ...
            HllSketch sketch2 = HllSketch.heapify(WritableMemory.writableWrap(bytes2));
